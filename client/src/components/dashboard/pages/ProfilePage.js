...
class ProfilePage extends React.Component {
  ...
  async componentDidMount(){
    ...
    const {farmer} = data;
    this.setState({loading:false,email:farmer.email,name:farmer.name,city:farmer.city, id:farmer._id})
  }
  catch{
        ...
        <div class="row my-2 ml-5 mt-5"> 
          ...
          <div class="col-lg-8 order-lg-1 personal-info">
            ...
            />
                ...
                <div className="profile-info-name" style={{fontSize:"20px"}}> {user.name} </div>
              </div>
              <div class="form-group row">
                <label class="col-lg-3 col-form-label form-control-label" style={{fontSize:"20px"}}>
                  Username :
            ...
            />
                ...
                <div className="profile-info-name" style={{fontSize:"20px"}}> {user.email} </div>
              </div>
              <div class="form-group row">
                <label class="col-lg-3 col-form-label form-control-label" style={{fontSize:"20px"}}> 
                  city :             <input
